...
<body id="ai-body">
    <div class="ai-theme-switch">
        <label for="ai-theme-toggle">Dark Mode</label>
        <input type="checkbox" id="ai-theme-toggle" onchange="toggleTheme()">
    </div>
    ...
    <div class="ai-results-container" style="display: none;">
        ...
        <div id="ai-loader" class="ai-loader--style" style="display: block">
            <svg version="1.1" id="ai-loader-1" xmlns="http://www.w3.org/2000/svg"
